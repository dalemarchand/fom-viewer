...
function setupAppspaceButtons() {
  ...
  // Add info button next to Load/Change Appspace
  if (loadBtn && !document.getElementById('appspaceInfoBtn')) {
    ...
    loadBtn.parentNode.insertBefore(infoBtn, clearBtn);
...
function showAppspaceFormatModal() {
  ...
  const exampleContent = `# Application Space Mapping File
      ...
      <div style="padding:24px;">
        ...
        <div style="margin-bottom:16px;">
          ...
          <ul style="margin:8px 0 0 20px;color:var(--text-secondary);">
            <li>Each line: <code style="background:var(--bg-tertiary);padding:2px 6px;border-radius:4px;">ClassName|app1,app2,app3</code></li>
            <li>Use <code style="background:var(--bg-tertiary);padding:2px 6px;border-radius:4px;">|</code> to separate class name from applications</li>
            <li>Use <code style="background:var(--bg-tertiary);padding:2px 6px;border-radius:4px;">,</code> to separate multiple applications</li>
        ...
        <div style="background:var(--bg-tertiary);padding:12px 16px;border-radius:var(--radius-sm);margin-top:16px;">
          ...
          <span style="color:var(--text-secondary);font-size:13px;">Appspace files map HLA class names to applications. Used to track which FOM classes are used by which apps.</span>
        </div>
      </div>
    </div>
  `;
